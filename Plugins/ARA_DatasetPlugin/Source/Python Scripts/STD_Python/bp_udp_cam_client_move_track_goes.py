...
def main():
    ...
    argument_parser.add_argument('-t', '--track', type=str, default=os.path.join(".", "track_cam_light_goes_with_bind.csv"))
    ...
    argument_parser.add_argument('--idx_start', type=int, default=4)
    ...
    for i, cam_and_light_item in enumerate(cam_and_light_track):
        ...
        pose_idx = int(cam_and_light_item[0])
        camera_coords = cam_and_light_item[1:7]
        lighting_data = cam_and_light_item[7:]
