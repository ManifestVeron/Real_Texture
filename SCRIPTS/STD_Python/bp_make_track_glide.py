...
def main() -> None:
    ...
    # specific params
    argument_parser.add_argument('--uav_height', type=float, default=570)
    argument_parser.add_argument('--radius_of_circle', type=float, default=500)
    ...
    for idx_place, place in enumerate(places):
        ...
        while circle_point_idx < args.num_points:
            ...
            alpha = 360 - (360 // args.num_points) * circle_point_idx
