...
def main():
    ...
    # output files
    argument_parser.add_argument('--out_track_goes', type=str, default="track_goes_with_bind.csv")
    argument_parser.add_argument('--out_env_goes', type=str, default="env_goes_with_bind.csv")
    argument_parser.add_argument('--out_pairs', type=str, default="pairs_goes.csv")
    argument_parser.add_argument('--out_cam_sighting', type=str, default="cam_sighting_goes_with_bind.csv")
    ...
    # Open output files
    track_file = open(args.out_track_goes, "w")
    env_file = open(args.out_env_goes, "w")
    ...
    for idx, track_raw in enumerate(obzor_track_file):
        ...
        height = float(track_raw[2])    # - random.uniform(16500.0, 23500.0)
